...
terraform {
  ...
  backend "azurerm" {
    resource_group_name   = "manoj-storage" #change it with your storage account rg name 
    storage_account_name  = "manojstorageter" #change it with your storage account name
